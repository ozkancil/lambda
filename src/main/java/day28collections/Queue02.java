...
public class Queue02 {
    ...
    LIFO->Last in first out. Loading a truck, first in last out.

To use Deque its about adding first element, adding last, removing first and removing last.
    ...
    public static void main(String[] args) {
        ...
        /*
        Pushes an element onto the stack represented by this deque (in other words, at the head of this deque) if it is possible
